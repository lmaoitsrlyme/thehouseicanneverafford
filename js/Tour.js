AFRAME.registerComponent("tour", {
  ...
  createPlace: function() {
    const details = {
      garden: {
        ...
        title: "pool for the house i can never afford",
        id: "garden"
      },
      main_gate: {
        ...
        title: "gate for the house i can never afford",
        id: "main_gate"
      },
      home: {
        ...
        title: "the inside of the house i can never afford",
        id: "home"
      }
    };
  ...
  createTitleEl: function(item) {
    ...
    if (item.title === "gate for the house i can never afford") {
